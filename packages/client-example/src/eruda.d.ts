 ...
 */
 declare module 'eruda' {
  ...
  export interface Settings extends Tool {
     ...
     */
    remove(cfj: Record<string, unknown>, name: string): void;
    /**
     * Add text
     */
     ...
     */
    switch(cfg: Record<string, unknown>, name: string, desc: string): void;
    /**
     ...
     */
    select(cfg: Record<string, unknown>, name: string, desc: string, values: string[]): void;
    /**
     ...
     */
    color(cfg: Record<string, unknown>, name: string, desc: string, colors: string[]): void;
    /**
     * Add a separator
     */
    separator(): void;
  ...
  export interface DevTools extends Emitter {
    ...
    hide(): DevTools;
    toggle(): void;
    add(tool: Tool | Record<string, unknown>): DevTools;
    ...
    notify(content: string, options: Record<string, unknown>): void;
    destroy(): void;
  }
  ...
  export interface Util {
    createCfg(name: string): Record<string, unknown>;
    defaults(obj: Record<string, unknown>, ...src: Record<string, unknown>[]): Record<string, unknown>;
  }
